...
class ThreadsDestination(IDestination):
    ...
    def post(self, content: Dict) -> bool:
        ...
        """
        current_token = token_manager.load_token().get("access_token")
        ...
        container_creation_url = f"{settings.THREADS_API_BASE_URL}{settings.THREADS_API_VERSION}/{settings.INSTAGRAM_USER_ID}/threads"
        container_payload = {
            "media_type": "TEXT",
            "text": text_to_post,
